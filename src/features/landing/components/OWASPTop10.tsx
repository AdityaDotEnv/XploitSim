...
const OWASPTop10: React.FC = () => {
  ...
  const newVulnerabilities2025: Vulnerability[] = [
    {
      id: "3",
        ...
        <div className={styles.cardImage}>
          <img
            ...
            onError={(e) => {
              ...
              (e.target as HTMLImageElement).src = `https://via.placeholder.com/400x200/667eea/ffffff?text=Security+${vulnerability.id}`;
            }}
          />
